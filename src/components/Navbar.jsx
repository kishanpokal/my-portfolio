...
const ThemeToggle = () => {
  ...
  if (!mounted) {
    return (
      <div className="w-[38px] h-[38px] bg-background/60 border border-border/50 rounded-xl" />
    );
  }
        ...
        <Magnetic strength={0.5}>
          <motion.a
            ...
            className={cn(
              ...
              "shadow-sm hover:shadow-[0_0_18px_hsl(var(--primary)/0.35)]",
        ...
        <Magnetic strength={0.5}>
          <motion.a
            ...
            className={cn(
              ...
              "border border-border/50 hover:border-blue-400/40",
              "shadow-sm hover:shadow-[0_0_18px_rgba(59,130,246,0.35)]",
              "transition-all duration-300"
            )}
            whileHover={{ scale: 1.1, y: -2 }}
            whileTap={{ scale: 0.9 }}
      ...
      >
        <motion.div
          ...
          className={cn(
            ...
            "shadow-[0_4px_24px_rgba(0,0,0,0.06),0_1px_4px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]",
