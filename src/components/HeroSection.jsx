...
export const HeroSection = () => {
  ...
  const achievements = [
    { number: "4+", label: "Software Projects", icon: <Code className="h-3 w-3" /> },
    { number: "Android", label: "App Development", icon: <Zap className="h-3 w-3" /> },
    { number: "AI &", label: "Automation", icon: <Sparkles className="h-3 w-3" /> },
    { number: "Active", label: "Learner", icon: <Award className="h-3 w-3" /> }
  ];
