...
export const AboutSection = () => {
  ...
  const achievements = [
    { number: "6+", label: "Development Projects", icon: <Briefcase className="h-5 w-5" />, suffix: "" },
  ...
  const handleDownload = () => {
    ...
    link.href = '/Kishan-resume.pdf'; // Must be in public folder
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Kishan Pokal</h2>
                    <p className="text-primary text-base sm:text-lg font-semibold mb-3 sm:mb-4">Full-Stack Developer | AI Learner</p>
                ...
                <div className="min-h-[100px] sm:min-h-[120px]">
                  <AnimatePresence mode="sync">
                    <motion.div
                      ...
                      className="text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed space-y-4"
                    >
